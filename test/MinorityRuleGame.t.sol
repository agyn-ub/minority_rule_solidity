...
contract MinorityRuleGameTest is Test {
    ...
    function testSetCommitDeadlineAndJoinGame() public {
        ...
        (, , , , uint8 state, , , , , , uint256 commitDeadline, ) = game.getGameInfo(gameId);
        ...
        // Check game state
        (, , , , , , uint32 totalPlayers, , , uint256 prizePool, , ) = game.getGameInfo(gameId);
    ...
    function testPrizeDistribution() public {
        ...
        assertEq(player3.balance, initialPlayer3Balance - ENTRY_FEE + winnerPrize);
        assertEq(platformFeeRecipient.balance, initialPlatformBalance + platformFee);
    }
    ...
    function testCannotJoinAfterRound1() public {
        ...
        // Two players join and play round 1
        vm.prank(player1);
        game.joinGame{value: ENTRY_FEE}(gameId);
        vm.prank(player2);
        game.joinGame{value: ENTRY_FEE}(gameId);
        
        // Complete round 1 (both players advance to round 2)
        bytes32 salt1 = keccak256("salt1");
        bytes32 salt2 = keccak256("salt2");
        ...
        // This should start round 2
        game.processRound(gameId);
        
        // Try to join in round 2 (should fail)
        vm.prank(player3);
